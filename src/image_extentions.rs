...
pub struct ImageWidgetExtender{}
...
pub struct ImageEffectHandler{original_image : DynamicImage, edited_image : DynamicImage}

impl ImageEffectHandler{

    pub fn new(original_image : DynamicImage) -> Self{
    ...
    pub fn image_wave_effect(&mut self) -> DynamicImage{
